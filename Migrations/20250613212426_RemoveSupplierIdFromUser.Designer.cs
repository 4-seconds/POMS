...
namespace PurchaseOrderManagementSystem.Migrations
{
    ...
    [Migration("20250613212426_RemoveSupplierIdFromUser")]
    partial class RemoveSupplierIdFromUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PurchaseOrderManagementSystem.Models.PurchaseOrder", b =>
                {
                    ...
                    b.HasOne("PurchaseOrderManagementSystem.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                    ...
                    b.HasOne("PurchaseOrderManagementSystem.Models.ApplicationUser", "Requested_by")
                        .WithMany()
